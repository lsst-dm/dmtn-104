% auto generated from MagicDraw (revision) 323 - DO NOT EDIT!
...
\end{longtable}
   ...
   \newpage
\subsubsection{LSP Software Products}\label{lspsw}
\begin{longtable}{p{3.7cm}p{3.7cm}p{3.7cm}p{3.7cm}}\hline
\textbf{Manager} & \textbf{Owner} & \textbf{WBS} & \textbf{Team} \\ \hline
\parbox{3.5cm}{
Frossie Economou
...
\end{tabular} \\ \hline
\multicolumn{4}{c}{
{\footnotesize ( Portal Online Help
 - PRTLOH ) }
}\\ \hline
\end{longtable}
...
\end{tabular} \\ \hline
\multicolumn{4}{c}{
{\footnotesize ( Gen. P. File System
 - GPFS ) }
}\\ \hline
\end{longtable}
