% auto generated from MagicDraw (revision) 328 - DO NOT EDIT!
...
\item Header Generator - \hyperlink{heads}{HEADS}
...
\end{tabular} \\ \hline
\multicolumn{4}{c}{
{\footnotesize Short name: \textbf{ Header Generator
...
repository.\\
~\\
\emph{{{[}last review: ~G. Dubois-Felsmann - Feb 2020{]}}}
...
\end{longtable}
  ...
  \newpage
\paragraph{Low Level SW}\label{llsw}\mbox{}\\
\begin{longtable}{p{3.7cm}p{3.7cm}p{3.7cm}p{3.7cm}}\hline
\textbf{Manager} & \textbf{Owner} & \textbf{WBS} & \textbf{Team} \\ \hline
\parbox{3.5cm}{
...
\end{tabular} \\ \hline
\multicolumn{4}{c}{
{\footnotesize Short name: \textbf{ Low Level SW
 } - Product key: \textbf{ LLSW } }
}\\ \hline
\end{longtable}
...
\textbf{Products included in this section}:
\begin{itemize}
\item RedHat CentOS - \hyperlink{centos}{CENTOS}
\end{itemize}
}
...
\end{tabular} \\ \hline
\multicolumn{4}{c}{
{\footnotesize Short name: \textbf{ OS (e.g.)
 } - Product key: \textbf{ CENTOS } }
}\\ \hline
\end{longtable}
