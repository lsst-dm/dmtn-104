% auto generated from MagicDraw (revision) 322 - DO NOT EDIT!
...
\item
  LSP WebAPIs Aspect (TAP, SODA, SIA and WebDAV)
\end{itemize}
...
~\\
The service is defined using a Dockerfile template provided by the third
party package \emph{\textbf{firefly}}, and build using the
configurations provided in the \href{https://github.com/lsst/suit}{suit}
~Git package.
