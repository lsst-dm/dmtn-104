% auto generated from MagicDraw (revision) 334 - DO NOT EDIT!
...
\item Network Management - \hyperlink{ncsanetmng}{NCSANETMNG}
...
\end{longtable}
    ...
    \newpage
\begin{longtable}{p{3.7cm}p{3.7cm}p{3.7cm}p{3.7cm}}\toprule
\multicolumn{2}{l}{\large \textbf{ \hypertarget{ncsanetmng}{Network Management} } }
& \multicolumn{2}{l}{(product in: IT NCSA
)}
\\ \hline
\textbf{\footnotesize Manager} & \textbf{\footnotesize Owner} &
