...
\node (BPSWP) [pbox, 
right=96pt of BBSWP] {\textbf{Batch Prod. SW P.
...
\node (ENVS) [pbox, 
right=96pt of BPSWP] {\textbf{Environments
...
\node (LSPSWP) [pbox, 
right=96pt of ENVS] {\textbf{LSP SW Products
...
\node (PRSW) [pbox, 
right=96pt of LSPSWP] {\textbf{Prompt SW Prod.
...
\node (QCSWP) [pbox, 
right=96pt of PRSW] {\textbf{QC SW Products
...
\node (SCIPSWP) [pbox, 
right=96pt of QCSWP] {\textbf{Sci Pipelines SW P.
...
\node (DMSW) [wbbox, above=43pt of LSPSWP]{\textbf{Software Products}};
