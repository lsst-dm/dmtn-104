...
\usepackage[paperwidth=565.0pt,paperheight=344pt,
...
\node (DSPLSW) [pbox, 
right=96pt of DMDSS] {\textbf{Dev Science Pipelines
...
\node (DENV) [pbox, 
right=96pt of DSPLSW] {\textbf{DM DevM Envs
...
\node (DMDSW) [wbbox, above=43pt of DSPLSW]{\textbf{Development Software Products}};
 ...
 \draw[pline]   (DENV.north) -- ++(0.0,0.5) -| (DMDSW.south) ; 
