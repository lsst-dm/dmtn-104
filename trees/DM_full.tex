...
\usepackage[paperwidth=3978pt,paperheight=1849pt,
...
\node (DMSRV) [pbox, 
right=96pt of DMDTDP] {\textbf{Services
...
\node (full_DM) [wbbox, above=43pt of DMSRV]{\textbf{Full DM Tree}};
 \draw[pline]   (DMDC3E.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (DMDSRV.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (DMDSW.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (DMDTDP.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (DMSRV.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (DMSW.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (HWCOTS.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (INFRA.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
 \draw[pline]   (REFD.north) -- ++(0.0,0.5) -| (full_DM.south) ; 
