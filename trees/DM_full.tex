...
\usepackage[paperwidth=2168.0pt,paperheight=2304pt,
...
\node (SPLWF) [pbox,below=6pt of SPLUG] {\textbf{SPL Workflow
 ...
 \draw[pline] (SCIPSWP.south) -| ++(0,0) |- (SPLWF.west); 
...
\node (SPSWP) [pbox,below=393pt of SCIPSWP] {\textbf{Supporting SW P.
...
\node (FACFR) [pbox,below right=6pt and -14pt of DF] {\textbf{France Data Facility
} };\node [below right] at (FACFR.north west) {\footnotesize \color{blue}} ;

 \draw[pline] (DF.south) -| ++(0,0) |- (FACFR.west); 
...
\node (ENC) [pbox,below=178pt of FAC] {\textbf{Enclaves
