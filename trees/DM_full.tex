...
\usepackage[paperwidth=2660.0pt,paperheight=1917pt,
...
\node (LSPSWP) [pbox,below=92pt of BPSWP] {\textbf{LSP SW Products
...
\node (DMHW) [pbox,below=522pt of COTS] {\textbf{DM Hardware
...
\node (LLSW) [pbox,below=6pt of HWSTOR] {\textbf{Low Level SW
 ...
 \draw[pline] (DMHW.south) -| ++(0,0) |- (LLSW.west); 
...
\node (THPL) [pbox,below=221pt of DMHW] {\textbf{Third Party Libs
...
\node (INFRA) [pbox, 
right=288pt of HWCOTS] {\textbf{Infrastructure
