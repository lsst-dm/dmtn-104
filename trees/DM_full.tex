...
\node (OCSBATSRVpkg) [tbox,below=3mm of OCSBATSRV.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
...
\node (OCSBATpkg) [tbox,below=3mm of OCSBAT.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
...
\node (NETNCSApkg) [tbox,below=3mm of NETNCSA.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
...
\node (FACNCSApkg) [tbox,below=3mm of FACNCSA.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
...
\node (ENCPRNpkg) [tbox,below=3mm of ENCPRN.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
...
\node (ENCARCNpkg) [tbox,below=3mm of ENCARCN.north] {{\footnotesize \color{black} \begin{verbatim}  \end{verbatim} }  };
