...
\usepackage[paperwidth=2756.0pt,paperheight=2089pt,
...
\node (STMNG) [pbox,below=6pt of NETMGMT] {\textbf{Storage Mgmt
 ...
 \draw[pline] (ITSRV.south) -| ++(0,0) |- (STMNG.west); 
\node (LSPSRV) [pbox,below=522pt of ITSRV] {\textbf{LSP Services
...
\node (DMDC3E) [pbox, 
right=192pt of REFD] {\textbf{COTS 3rdPLs ENVs
...
\node (DENV) [pbox,below right=6pt and -14pt of DMDSW] {\textbf{DM DevM Envs
} };\node [below right] at (DENV.north west) {\footnotesize \color{blue}} ;

 \draw[pline] (DMDSW.south) -| ++(0,0) |- (DENV.west); 
\node (DMDSS) [pbox,below=6pt of DENV] {\textbf{DMDev Supp SW
