...
\node (DMDC3E) [pbox,right=43pt of DMDEV] {\textbf{COTS 3rdPLs ENVs
...
\node (DMDSRV) [pbox,below=178pt of DMDC3E] {\textbf{Support Services
...
\node (DENV) [pbox,right=43pt of DMDSW] {\textbf{DM DevM Envs
