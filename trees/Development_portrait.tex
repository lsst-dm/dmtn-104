...
\usepackage[paperwidth=612pt,paperheight=989pt,
...
\node (DMDEV) [wbbox]{\textbf{DM Development Components}};
...
\node (DENV) [pbox,below=221pt of COTSDM] {\textbf{DM DevM Envs
...
\node (DMDSRV) [pbox,below=264pt of DMDC3E] {\textbf{Support Services
...
\node (DMDTDP) [pbox,below=178pt of DMDSW] {\textbf{Test Data
