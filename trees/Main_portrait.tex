...
\node (LSPWAPI) [pbox,below=6pt of LSPNBL] {\textbf{LSP Web API
...
\node (PRTL) [pbox,below=6pt of LSPWEBSRV] {\textbf{LSP Portal
} };\node [below right] at (PRTL.north west) {\footnotesize \color{blue}1.02C.05.07 1.02C.05.08} ;

 \draw[pline] (LSPSRV.east) -| ++(0.4,0) |- (PRTL.west); 
...
\node (NB) [pbox,below=6pt of LSPWEB] {\textbf{LSP Notebook SW
} };\node [below right] at (NB.north west) {\footnotesize \color{blue}1.02C.10.02.02} ;
\node (NBpkg) [tbox,below=3mm of NB.north] {{\footnotesize \color{black} \begin{verbatim} lsst-sqre/jupyterhubutils lsst-sqre/jupyterlabutils \end{verbatim} }  };

 \draw[pline] (LSP.east) -| ++(0.4,0) |- (NB.west); 
\node (PRTLSW) [pbox,below=6pt of NB] {\textbf{LSP Portal SW
...
\node (PRTLSWpkg) [tbox,below=3mm of PRTLSW.north] {{\footnotesize \color{black} \begin{verbatim} suit \end{verbatim} }  };
 ...
 \draw[pline] (LSP.east) -| ++(0.4,0) |- (PRTLSW.west); 
\node (SUITOH) [pbox,below=6pt of PRTLSW] {\textbf{SUIT OnlineHelp
