...
\node (IDNMNG) [pbox,right=43pt of ITSRV] {\textbf{Identity Mngt
...
\node (ITRCK) [pbox,below=135pt of ITNCSA] {\textbf{Issue Tracking
...
\node (LSPSRV) [pbox,below=565pt of ITSRV] {\textbf{LSP Services
