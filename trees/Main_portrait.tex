...
\node (LSPSW) [pbox,below=92pt of DBB] {\textbf{LSP SW Products
} };\node [below right] at (LSPSW.north west) {\footnotesize \color{blue}} ;

 \draw[pline] (DMSW.east) -| ++(0.4,0) |- (LSPSW.west); 
\node (DAXIMG) [pbox,right=43pt of LSPSW] {\textbf{Image Server SW
...
\node (DAXIMGpkg) [tbox,below=3mm of DAXIMG.north] {{\footnotesize \color{black} \begin{verbatim} dax_imgserv \end{verbatim} }  };
 ...
 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (DAXIMG.west); 
...
\node (LSPWEBpkg) [tbox,below=3mm of LSPWEB.north] {{\footnotesize \color{black} \begin{verbatim} dax_webserv \end{verbatim} }  };
 ...
 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (LSPWEB.west); 
...
\node (NBSWpkg) [tbox,below=3mm of NBSW.north] {{\footnotesize \color{black} \begin{verbatim} lsst-sqre/jupyterhubutils lsst-sqre/jupyterlabutils \end{verbatim} }  };
 ...
 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (NBSW.west); 
\node (PRTLSW) [pbox,below=6pt of NBSW] {\textbf{LSP Portal SW
...
\node (PRTLSWpkg) [tbox,below=3mm of PRTLSW.north] {{\footnotesize \color{black} \begin{verbatim} suit \end{verbatim} }  };
 ...
 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (PRTLSW.west); 
...
\node (SUITOHpkg) [tbox,below=3mm of SUITOH.north] {{\footnotesize \color{black} \begin{verbatim} suit-onlinehelp \end{verbatim} }  };
 ...
 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (SUITOH.west); 
\node (TAPSW) [pbox,below=6pt of SUITOH] {\textbf{TAP Software
} };\node [below right] at (TAPSW.north west) {\footnotesize \color{blue}} ;

 \draw[pline] (LSPSW.east) -| ++(0.4,0) |- (TAPSW.west); 
\node (PR) [pbox,below=221pt of LSPSW] {\textbf{Prompt SW
