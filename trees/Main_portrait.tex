...
\usepackage[paperwidth=765pt,paperheight=4085pt,
...
\node (LSPJLSRV) [pbox,right=43pt of LSPSRV] {\textbf{LSP JupyterLab
...
\node (DMSW) [pbox,below=1124pt of DMSRV] {\textbf{Software Products
...
\node (INFRA) [pbox,below=780pt of HWCOTS] {\textbf{Infrastructure
