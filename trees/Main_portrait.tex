...
\usepackage[paperwidth=765pt,paperheight=4171pt,
...
\node (DMSW) [pbox,below=1167pt of DMSRV] {\textbf{Software Products
...
\node (LSPSWP) [pbox,below=49pt of BPSWP] {\textbf{LSP SW Products
...
\node (DMHW) [pbox,below=479pt of COTS] {\textbf{DM Hardware
...
\node (LLSW) [pbox,below=6pt of HWSTOR] {\textbf{Low Level SW
 ...
 \draw[pline] (DMHW.east) -| ++(0.4,0) |- (LLSW.west); 
