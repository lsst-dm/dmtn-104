...
within the DBB based on a set of policies. Products may move from
...
defined time periods as specified in requirements. Intermediates may be
kept until all downstream products have been generated.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
&
\\ \bottomrule
\end{longtable}
...
the end user. These services are usually referred as ``LSP Aspects'':
...
More details available in LDM-542 and LSE-319.
...
\end{longtable}
  ...
  This service collects all KPI metrics calculated by the processing
service, aggregate the information and provides reports in order to
ensure the monitoring of the quality of the processing and of the data
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Header Service SW (HEADER) \\ \hline
EFD Transformation (EFDT) \\ \hline
Image Ingest and Processing (IIP) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Planned Observation Publication SW (OBSPUB) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  Telemetry Gateway Service This service is implemented by the DMCS, a
more general system that manages communication from and to the
Observatory.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Batch Production (PRODSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  This software product will implemented the management of the data in the
sciences storage. SW still to be written.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
DBB Lifetime Management (DBBLIFESRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
services from the Facilities enclaves to the backbone. Software to be
written.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
DBB Ingest/ Metadata Management (DBBMDSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
preservation. Software still to be writte.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
DBB Storage (DBBSTRSRV) \\ \hline
DBB Transport/ Replication/ Backup (DBBTRSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Alert Distribution (ALRTDSTSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\begin{longtable}{c}\hline
\textbf{GutHub Packages} \\ \hline
\href{https://github.com/lsst/HeaderService}{HeaderService}\\ \hline
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Prompt Processing Ingest (PRPINGSRV) \\ \hline
Archiving (ARCSRV) \\ \hline
Telemetry Gateway (TMGSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  Pointing Prediction Publishing SW products Software Still to be written
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Planned Observation Publication (POPSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  Batch commandable SAL component. SW to be written.
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
OCS-Driven Batch (OCSBATSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  SW Product to use in the OODS service. Still to be written
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Observatory Operations Data (OODSSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Offline Quality Control (OFFLQCSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  DM software products used as libraries and shared between different SW
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
Containerized Application Management (CAM) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
LSP Web API (LSPWEBSRV) \\ \hline
LSP Portal (LSPPRTLSRV) \\ \hline
LSP JupyterLab (LSPJLSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
LSP Web API (LSPWEBSRV) \\ \hline
LSP Portal (LSPPRTLSRV) \\ \hline
Archive Base Enclave (ENCARCB) \\ \hline
LSP JupyterLab (LSPJLSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
...
\begin{tabular}{c}
Offline Quality Control (OFFLQCSRV) \\ \hline
Bulk Distribution (BULKDSRV) \\ \hline
Batch Production (PRODSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
...
\begin{tabular}{c}
Prompt Processing Ingest (PRPINGSRV) \\ \hline
Prompt Processing (PRPRSRV) \\ \hline
Offline Quality Control (OFFLQCSRV) \\ \hline
Alert Distribution (ALRTDSTSRV) \\ \hline
Prompt Quality Control (PRQCSRV) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
DAC Chile Enclave (ENCDACC) \\ \hline
Archive Base Enclave (ENCARCB) \\ \hline
Prompt Base Enclave (ENCPRB) \\ \hline
Commissioning Cluster Enclave (ENCCOMM) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\textbf{Implemented by} & \textbf{Used in}\\ \toprule
\begin{tabular}{c}
DAC US Enclave (ENCDACU) \\ \hline
Archive NCSA Enclave (ENCARCN) \\ \hline
Development and Integration E. () \\ \hline
Offline Production Enclave (ENCOFFL) \\ \hline
Archive NCSA Enclave (ENCARCN) \\ \hline
Prompt NCSA Enclave (ENCPRN) \\ \hline
\end{tabular}
&
\\ \bottomrule
\end{longtable}
...
\end{longtable}
  ...
  Santiago - Boca Raton Spectrum Is this a network? Or a component used?
