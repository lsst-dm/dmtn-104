...
levels (LSE-61, interface, low level flow down
...
The components required for development, but not used for operations,
are not part of this Products Tree.
...
\end{longtable}
  ...
  DM operational services. This includes all services required for: - data
distribution (DBB) - data processing (prompt and offline) - data access
(LSP)
...
\end{longtable}
  ...
  DM services that permit external users to access the project resources,
such as data and processing SW.
...
\textbf{Product Dependencies} \\ \hline
LSPJL \\ \hline
\end{longtable}
...
\end{longtable}
  ...
  It provides a pre-specified yet flexible discovery, query, and viewing
tool.
