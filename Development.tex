...
\multicolumn{2}{c}{
\begin{tabular}{c}
\hyperref[jnkns]{Jenkins} \\ \hline
\hyperref[jscr]{jenkins scripting} \\ \hline
\end{tabular}
} &
\multicolumn{2}{c}{
} \\ \bottomrule
...
\end{longtable}
     ...
     \newpage
\begin{longtable}{p{3.7cm}p{3.7cm}p{3.7cm}p{3.7cm}}\toprule
\multicolumn{2}{l}{\large \textbf{ jenkins scripting } }\label{jscr}
& \multicolumn{2}{l}{(product in: DMDev Supp SW
)}
\\ \hline
\textbf{\footnotesize Manager} & \textbf{\footnotesize Owner} &
...
\multicolumn{2}{c}{
\begin{tabular}{c}
\hyperref[swver]{SW Version Control} \\ \hline
\end{tabular}
} \\ \bottomrule
\multicolumn{4}{c}{\textbf{Related Requirements} } \\ \hline
\end{longtable}
